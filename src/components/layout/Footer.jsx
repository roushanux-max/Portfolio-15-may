...
export const Footer = () => (
  <footer id='contact' className='py-12 border-t border-gray-800 text-center'>
    <div className='flex justify-center gap-6 mb-8'>
      ...
      <a href='#' className='hover:text-purple-500 transition-colors'><Mail /></a>
    </div>
    <p className='text-gray-500'>© 2024 Roushan. Built with React, GSAP & Framer Motion.</p>
  </footer>
);
